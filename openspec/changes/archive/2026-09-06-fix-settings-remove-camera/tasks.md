...
- [x] 3.3 Manual verification: add a USB camera, click Remove, confirm, cancel, and remove a default source; confirm the source list is persisted after reopening the settings panel and that the app does not try to start a removed source.
